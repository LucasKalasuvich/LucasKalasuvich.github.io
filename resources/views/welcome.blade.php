  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light">Lucas Kalasuvich</h1>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="{{asset('assets/CV_Lucas Kalasuvich NEW.pdf')}}" class="btn btn-light btn-lg text-dark nav-link scrollto"><i class="bx bx-download text-dark"></i> <span>Curriculum Vitae</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>UI/UX Designer, Backend Developer &amp; Web Developer.</h3>
            <br>
            {{-- <p class="fst-italic">
            ...
            <p>Fresh graduate jurusan Teknik Informatika Bina Nusantara University yang sedang mencari kesempatan karir di bidang IT. Selama berkuliah, saya melakukan internship selama 1 tahun di Dewan Perwakilan Rakyat Republik Indonesia (DPR RI) sebagai Web Developer yang membuat serta mengolah pada website menggunakan framework Laravel dengan bahasa pemprograman PHP, HTML/CSS, JAVASCRIPT, MYSQL. Saya juga hobi membuat tampilan design website yang cukup menarik bagi para pengguna dengan menggunakan figma. </p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <h5>2022 - 2023 (1 Tahun)</h5>
              <p><em>Sekretariat Jenderal Dewan Perwakilan Rakyat Republik Indonesia (Sekjen DPR RI) </em></p>
              <ul>
                <li>Membuat Website Persiapan Bahan Rapat Paripurna Menggunakan Framework Laravel</li>
                <li>Membuat Website Tanda Tangan Elektronik Menggunakan Framework Laravel, Algoritma RSA Dan SHA-512</li>
              </ul>
            </div>
            {{-- <div class="resume-item">
